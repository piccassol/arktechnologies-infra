        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-blue-600 rounded-lg flex items-center justify-center">
                <svg viewBox="0 0 100 100" className="w-6 h-6 text-white fill-current">
                  ...
                  <line x1="35" y1="45" x2="35" y2="65" stroke="currentColor" strokeWidth="2"/>
                  <line x1="50" y1="35" x2="50" y2="65" stroke="currentColor" strokeWidth="2"/>
                  <line x1="65" y1="45" x2="65" y2="65" stroke="currentColor" strokeWidth="2"/>
                </svg>
              </div>
              <span className="text-xl font-bold">ARK Technologies</span>
            </div>
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#contact" className="bg-gradient-to-r from-purple-600 to-blue-600 px-4 py-2 rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all">Get Free Audit</a>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} id="hero">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-8 py-4 rounded-lg text-lg font-semibold transition-all transform hover:scale-105">
                Get Your Free Automation Audit
              </button>
              <button className="border border-gray-600 hover:border-gray-400 px-8 py-4 rounded-lg text-lg font-semibold transition-all">
                See How It Works
              </button>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Lead qualification and consultation scheduling for high-value service providers.",
                  features: ["Lead qualification", "Calendar integration", "Follow-up sequences"]
                },
                {
                  title: "E-commerce",
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className={`relative bg-gray-800/50 p-6 rounded-xl border transition-all hover:bg-gray-800/70 ${plan.popular ? 'border-purple-500 scale-105' : 'border-gray-700'}`}>
                  ...
                  <button className={`w-full py-3 rounded-lg font-semibold transition-all ${plan.popular ? 'bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700' : 'border border-gray-600 hover:border-gray-400'}`}>
                    {plan.cta}
                  </button>
                </div>
              ))}
      ...
      <footer className="bg-black py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-lg font-bold">ARK Technologies</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2024 ARK Technologies. All rights reserved. • Built for enterprise automation • No vendor lock-in</p>
          </div>
        </div>
      </footer>
    </div>
